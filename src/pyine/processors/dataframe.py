...
def pivot_by_dimension(
    ...
    """
    try:
        # Find index columns (all except dimension and value)
        index_cols = [col for col in df.columns if col not in [dimension, value_column]]
...
def aggregate_by_period(
    ...
    try:
        ...
        result = df.groupby(period_column)[value_column].agg(agg_func).reset_index()
